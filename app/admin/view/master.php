    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="{{u('Entry.index')}}" style="color: white;margin-left: -14px">Mr.Rao的博客系统</a></h4>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{u('admin.user.changePsw')}}">修改密码</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{u('admin.user.out')}}">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
