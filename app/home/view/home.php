            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 footer-widget">
                        ...
                        <ul class="clean-list">
                            <foreach from="$newArticle" key="$k" value="$v">
...
<!--                            <a href="http://www.google.com"><i class="fa fa-google"></i></a>-->
                            <foreach from="$link" key="$k" value="$v">
                                <p><a href="{{$v['url']}}" target="_blank"><i class="fa">{{$v["lname"]}}</i></a>
                                    <img style="width: 15px;height: 15px;" src="{{$v['logo']}}" alt="">
                                </p>
                            </foreach>
                        </div>
                    </div>
