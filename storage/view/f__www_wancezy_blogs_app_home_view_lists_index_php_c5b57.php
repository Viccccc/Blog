    ...
    <div class="widewrapper subheader">
        <div class="container">
            <h2 style="margin: 0 auto;" class="clean-breadcrumb col-sm-12">
                <?php echo $HeadData["type"]?>:<?php echo $HeadData["name"]?>
            </h2>
            <div style="margin: 0 auto; class="clean-breadcrumb">
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp共 <?php echo $HeadData["total"]?> 篇文章
            </div>
        </div>
    </div>
    </header>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <article class=" blog-teaser">
                                    <header>
                                        <img style="width: 750px;height: 400px;" src="<?php echo $v['thumb']?>" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 footer-widget">
                        ...
                        <ul class="clean-list">
                                                        ...
                                                        <li><a href="arc_12.html">阿甘正传</a></li>
                                                    </ul>
                    </div>
