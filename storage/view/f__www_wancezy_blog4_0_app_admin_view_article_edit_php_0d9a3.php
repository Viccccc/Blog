                        ...
                        <select class="js-example-basic-single form-control" name="category_cid">
                            <option value="">请选择分类</option>
                                <?php if(!empty($categoryData)){ foreach ($categoryData as $k=>$v){?>
                                    <option value="<?php echo $v['cid']?>" <?php if($v['cid']==$oldData['category_cid']){?>
                selected
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox"  name="tag_tid[]" value="<?php echo $v['tid']?>" <?php if(in_array($v['tid'],$articleTag)){?>
                checked
               <?php }?> ><?php echo $v["tname"]?>
                            </label>
                            <?php }}?>
                    </div>
                </div>
...
<!--                    单图上传-->
                    <div class="col-sm-9">
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src="<?php echo $oldData['thumb']?>" class="img-responsive img-thumbnail haibao"
                                 width="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="keywords"  class="form-control" placeholder=""><?php echo $articleData['keywords']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章描述</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="des"  class="form-control" placeholder=""><?php echo $articleData['des']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
<!--                        百度编辑器-->
                        <textarea id="container" style="height:300px;width:100%;" name="content" ><?php echo $articleData['content']?></textarea>
                        <script>
