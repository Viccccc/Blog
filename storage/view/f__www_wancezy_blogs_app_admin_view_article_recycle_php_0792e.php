    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="http://localhost/wancezy/BlogS/index.php?s=admin/Entry/index" style="color: white;margin-left: -14px">CheliOus博客系统</a></h4>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo u('admin.article.restore',['aid'=>$v['aid']])?>">还原</a></li>
                                        <li class="divider"></li>
                                        <li><a href="<?php echo u('admin.article.del',['aid'=>$v['aid']])?>" onclick="" title="">彻底删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
