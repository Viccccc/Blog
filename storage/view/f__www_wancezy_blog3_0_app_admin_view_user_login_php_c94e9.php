...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    ...
    <div class="container aside-xxl">
        ...
        <a class="navbar-brand block" href="<?php echo __ROOT__?>">CheliOus博客后台管理</a>
        ...
        <section class="panel panel-default bg-white m-t-lg">
            ...
            <form method="post" action="" class="panel-body wrapper-lg">
                ...
                <div class="form-group">
                    ...
                    <input required type="password" id="inputPassword" class="form-control input-lg" name="password">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo u('admin.user.code')?>" onclick="this.src = this.src + '&rand=' + Math.random()">
...
<footer id="footer">
    ...
    <div class="text-center padder">
        ...
        <p>
            ...
            <small>Powered By Chelious.com<br> copyright &copy; 2015</small>
