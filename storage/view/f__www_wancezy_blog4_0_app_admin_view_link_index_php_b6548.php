            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><img style="width: 30px;height: 30px;" src="<?php echo $v['logo']?>" alt=""></td>
                        <td><?php echo $v["sort"]?></td>
                        <td>
                            <div class="btn-group">
                                <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo u('admin.link.edit',['lid'=>$v['lid']])?>">编辑</a></li>
                                    <li class="divider"></li>
                                    <li><a href="<?php echo u('admin.link.del',['lid'=>$v['lid']])?>">删除</a></li>
                                </ul>
                            </div>
                        </td>
